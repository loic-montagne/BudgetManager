...
namespace BudgetManager.Web.Areas.Identity.Pages.Account.Manage
{
    public class ChangePasswordModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            /// </summary>
            [DataType(DataType.Password)]
            [Display(Name = "Field.ConfirmNewPassword")]
            [Compare("NewPassword", ErrorMessage = "Validation.NewPasswordMismatch")]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            StatusMessage = _localizer["Message.PasswordChanged"].Value;
